...
import com.silas270.blocktime.data.local.FlightLogDao
...
class LocalFlightLogRepository(
     ...
     * [AirportRepository.getVisitedGeography][com.silas270.blocktime.data.repository.AirportRepository.getVisitedGeography]
