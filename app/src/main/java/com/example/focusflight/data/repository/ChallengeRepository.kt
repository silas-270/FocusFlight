...
/**
 * Result of trying to start a new challenge instance - see docs/design/challenges.md's
...
interface ChallengeRepository {
     ...
     * specific challenge id (see docs/design/challenges.md#which-flights-count). No-op (returns
     ...
     * docs/design/mechanics.md's isolation matrix), including one flown under a *different*
     * active Route challenge's own session - Distance/Set-completion have no position pointer so
     * they passively credit any eligible flight regardless of its tag's specific scoping.
     */
    suspend fun creditEligibleFlight(destIata: String, distanceKm: Double)
}
