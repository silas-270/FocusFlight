 ...
 *  seeds [current] from `PreferencesRepository.getThemeMode()` on launch; the Account screen's
 *  toggle updates both this and the persisted value on change. `FocusFlightTheme` reads [current]
